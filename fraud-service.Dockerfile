# =============================================================================
# fraud-service — Multi-stage Dockerfile
# =============================================================================
...
RUN chmod +x gradlew && ./gradlew :fraud-service:dependencies --no-daemon -q 2>/dev/null || true

COPY common-lib/ common-lib/
COPY shared-events/ shared-events/
COPY fraud-service/ fraud-service/

RUN ./gradlew :fraud-service:bootJar --no-daemon -x test
...
WORKDIR /app
COPY --from=builder /workspace/fraud-service/build/libs/*.jar app.jar
